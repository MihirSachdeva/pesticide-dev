    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(blank=True, choices=[('Pending', 'Pending'), ('Closed', 'Closed'), ('Resolved', 'Resolved')], default='Pending', max_length=30, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Project',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(blank=True, default='#775ada', max_length=10)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('on_project_status_change', models.BooleanField(blank=True, default=True, null=True)),
                ('on_new_issue', models.BooleanField(blank=True, default=True, null=True)),
                ('on_issue_assign', models.BooleanField(blank=True, default=True, null=True)),
